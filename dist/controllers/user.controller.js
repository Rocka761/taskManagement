...
var _require3 = require("../utility/response"),
...
exports.create = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
    var _req$body, name, email, password, role, userId, t, data, errorType;
...
exports.getAllUsers = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
    var _req$body2, searchOptions, limit, page, sortBy, sortDirection, userId, query, _i, _Object$entries, _Object$entries$_i, key, values, likeArray, data, errorType;
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _req$body2 = req.body, searchOptions = _req$body2.searchOptions, limit = _req$body2.limit, page = _req$body2.page, sortBy = _req$body2.sortBy, sortDirection = _req$body2.sortDirection;
          ...
          _context2.prev = 4;
          _context2.next = 7;
          return req.db.User.findAll(query);
        case 7:
          data = _context2.sent;
...
exports.deleteUsers = /*#__PURE__*/function () {
...
exports.updateDetails = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee4(req, res) {
    var _req$body3, name, email, role, id, userId, t, data, errorType;
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$body3 = req.body, name = _req$body3.name, email = _req$body3.email, role = _req$body3.role, id = _req$body3.id;
          userId = req.payload.userId;
          _context4.next = 4;
          return req.db.seq.transaction();
        case 4:
...
exports.updatePassword = /*#__PURE__*/function () {
  var _ref6 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var _req$body4, password, id, userId, t, data, errorType;
